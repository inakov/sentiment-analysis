...
//  }
//
//  val writer = CSVWriter.open(new File("/home/inakov/Downloads/sentiment-analysis/src/main/resources/reviews.csv"))
...
//      val line = List(review.userId.toString, review.rating.toString, businessId,review.message)
//      writer.writeRow(line)
//    }
//  }
//
